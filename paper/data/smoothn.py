...
# From: https://github.com/SanParraguez/smoothn/blob/main/smoothn.py
# Author: Santiago Parraguez
# 
# This code is a Python implementation of the smoothn(y) algorithm 
# described by García (2010). The original source code (Matlab) can 
# be found at https://www.biomecardio.com/en/download.html
...
# 54:1167-1178. doi:10.1016/j.csda.2009.09.020.
